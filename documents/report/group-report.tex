...
\usepackage{fancyhdr}
\pagestyle{fancy}
\lhead{octoDrone: Simulation and Deployment for Autonomous Drone Networks}
\renewcommand{\footrulewidth}{0.4pt}% Line at the footer visible
\rhead{\thepage}
\cfoot{Henson, De Ivey, Gibson, and Seymour}
...
\chapter{Opening}
\epigraph{``The beginning is the most \\ important part of the work'' \\ -Plato, The Republic}
