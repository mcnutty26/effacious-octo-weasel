...
\begin{aside}
	...
	\begin{figure}[H]
		...
		\begin{tabular}{|c|c|c|}
			...
			\hline AT*PCMD_MAG & flag, roll, pitch,
			gaz, yaw, psi, psi
			...
			\hline AT*CONFIG_IDS & session, user, application
